...
public class SFragment extends Fragment {
    static final String TAG = SFragment.class.getSimpleName();
    static final boolean DEBUG = true;

    private static final String EXTRA_LEANBACK_BADGE_PRESENT = "LEANBACK_BADGE_PRESENT";
    private static final String ARG_PREFIX = SFragment.class.getCanonicalName();
     ...
     */
    public static SFragment newInstance(String query) {
